...
class EditeventAdminScreen extends StatefulWidget {
  @override
  _EditeventAdminScreen createState() => _EditeventAdminScreen();
}

class _EditeventAdminScreen extends State<EditeventAdminScreen> {
  @override
  ...
  back() {
    if (_value.text == "" || _value2.text == "") {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: const Text('Event edit successfully!'),
          duration: const Duration(milliseconds: 1500),
          backgroundColor: Colors.blue[200],
        ),
      );
