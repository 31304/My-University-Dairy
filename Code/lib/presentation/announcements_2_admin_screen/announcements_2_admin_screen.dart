...
import 'package:sami_s_application1/widgets/app_bar/appbar_subtitle.dart';
...
class Announcements2AdminScreen extends StatefulWidget {
  @override
  _Announcements2AdminScreen createState() => _Announcements2AdminScreen();
}

class _Announcements2AdminScreen extends State<Announcements2AdminScreen> {
  @override
    ...
    return SafeArea(
        child: Scaffold(
            ...
            body: SingleChildScrollView(
                child: Padding(
                    padding: getPadding(left: 15, top: 26),
                    child: Column(
  ...
  back() {
    if (_value.text == "" || _value2.text == "") {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: const Text('Messege send successfully!'),
          duration: const Duration(milliseconds: 1500),
          backgroundColor: Colors.blue[200],
        ),
      );
